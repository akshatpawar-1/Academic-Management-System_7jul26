...

	    {
            ...
            <div className="dashboard-panels">
...

                    {
                        dashboard.recentStudent ? (
                            <>
                                ...
                                <Link className="panel-link" to="/students">
                                    View All Students →
                                </Link>
                            </>
                        ) : (
                ...
                <div className="panel">
                    ...
                    {
                        dashboard.recentMarks && dashboard.recentMarks.length > 0 ? (
			<>
                            <table>
                                <thead>
                                    <tr>
                    	    ...
                    	    <Link className="panel-link" to="/marks">
                        	View All Marks →
                            </Link>
			</>
                        ) : (
                            <p className="empty-state">No marks added yet.</p>
                        )
                    }
